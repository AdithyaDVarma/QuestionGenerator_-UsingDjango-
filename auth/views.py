        ...
        try:
            ...
            if user:
                ...
                if user is not None:
                    ...
                    return redirect('dashboard')  # Replace 'home' with the name of your homepage URL
                else:
...
def signup(request):
    ...
    return render(request, 'register.html')  # Ensure this template exists and is configured
